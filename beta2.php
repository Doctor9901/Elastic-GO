...
<div class="container py-5 text-center">
  <h1 class="mb-4">Exercício: Alongamento</h1>

  <!-- GIF e câmera lado a lado -->
  <div class="video-section">
    <!-- Lado esquerdo: demonstração -->
    <div>
      <img src="https://i.pinimg.com/originals/01/69/5d/01695d6abc90e7889bd2925789206601.gif" 
           alt="Demonstração de Alongamento" class="border">
