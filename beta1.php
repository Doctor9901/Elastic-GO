...
<div class="container py-5 text-center">
  <h1>Caminhada</h1>
  <img src="https://www.bonsfluidos.com.br/wp-content/uploads/2022/08/idosos-de-80-anos.jpg" class="img-fluid rounded mb-3" style="max-height:300px;object-fit:cover">
  ...
  <form method="POST" action="resultado.php" id="formExercicio">
    ...
    <button type="submit" id="registrar" disabled class="btn btn-primary mt-3">Registrar Tempo</button>
  </form>
