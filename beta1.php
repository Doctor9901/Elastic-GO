...
<div class="container py-5 text-center">
  <h1 class="mb-4">Exercício: Caminhada</h1>

  <!-- GIF e câmera lado a lado -->
  <div class="video-section">
    <!-- Lado esquerdo: demonstração do exercício -->
    <div>
      <img src="https://mir-s3-cdn-cf.behance.net/project_modules/disp/c9932738420671.576129995a487.gif" 
           alt="Demonstração de Caminhada" class="border">
      <p class="label">Demonstração</p>
    </div>

    <!-- Lado direito: câmera do usuário -->
    <div>
